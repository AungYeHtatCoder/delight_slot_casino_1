        ...
        <div class="d-lg-flex">
          ...
          <div class="ms-auto my-auto mt-lg-0 mt-4">
            <div class="ms-auto my-auto">
              <a href="{{ route('admin.master.create') }}" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; Create New
                Master</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a class="me-1" href="{{ route('admin.master.edit', $user->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Edit User">
                  <i class="fas fa-pen-to-square text-info" style="font-size: 20px;"></i>
                </a>
                <a class="me-1" href="{{ route('admin.master.show', $user->id) }}" data-bs-toggle="tooltip" data-bs-original-title="Preview User Detail">
                  <i class="fas fa-eye text-warning" style="font-size: 20px;"></i>
                </a>
                <form class="d-inline" action="{{ route('admin.master.destroy', $user->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
